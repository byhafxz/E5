...
public class ServerWordCounterFrame extends JFrame {
...
private static final long serialVersionUID = 1L;
	 ...
	 */
	public ServerWordCounterFrame () {
		
		// Default frame setting
		this.setLayout(new BorderLayout());
		this.setTitle("TCP Word Counter Application: Server Side");
		...
		this.txtRequestStatus.setLineWrap(true);
